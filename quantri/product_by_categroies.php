...
<body>
            ...
            <div class="flex grid items-center grid-cols-8">
                ...
                <div class="col-span-2 ">
                    <nav class="flex">
                        ...
                        <li class="list-none "><a href="signUp.php" class="pl-4 flex items-center hover:text-red-600"><i
    ...
    <section class="bg-yellow-500">
        <div class="container mx-auto ">
            ...
            <ul class="flex p-3">
                <li class="px-8 text-lg text-white uppercase hover:font-bold hover:underline"><a href="" class="">Trang
                        chủ</a></li>
        ...
        <div class="container mx-auto">
            <div class="grid grid-cols-8 gap-5">
                ...
                <div class="col-span-6">
                    <h3 class="font-bold py-4 text-2xl text-center">Sản phẩm </h3>
                    <hr class="py-4">
                    <div class="grid grid-cols-3 gap-8 ">
                        <?php foreach ($product as $product) : ?>
                        <div class="">
                            <a
                                href="product_detail.php?pro_id=<?= $product['pro_id'] ?>&cate_id=<?= $product['cate_id'] ?>"><img
                                    src="../upload/<?= $product['pro_img'] ?>" alt="" class="w-full"></a>
                            <div class="py-4 text-center"><a href="">
                                    <h3 class="font-medium uppercase"><?= $product['pro_name'] ?></h3>
                                </a>
                                <p class="font-medium text-red-600"><?= $product['price'] ?></p>
                            </div>
                ...
                <div class="col-span-2">
                    ...
                    <div class="border border-solid mt-10 rounded-md">
                        ...
                        <div class="flex p-4 border-b border-solid">
                            ...
                            <a href="product_detail.php?pro_id=<?= $pro['pro_id'] ?>&cate_id=<?= $pro['cate_id'] ?>"
