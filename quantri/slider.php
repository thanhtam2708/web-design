                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="addSlider.php" class="btn btn-primary">Thêm Slide</a>
                                </div>
                                <div class="card-body">
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="../upload/<?= $slider['slider_img'] ?>" width="150px" />
                                                </td>
                                                <td> <a href="editSlider.php?slider_id=<?= $slider['slider_id'] ?>"
                                                        type="submit" class="btn btn-primary" name="sua">Sửa</a> <a
                                                        href="deleteSlider.php?slider_id=<?= $slider['slider_id'] ?>"
