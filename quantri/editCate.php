...
if (isset($_POST['btnSua'])) {
    ...
    echo $img;
    $sql = "UPDATE categories set cate_name='$cate_name', cate_img='$img' where cate_id =  '$cate_id'";
    $stmt = $conn->prepare($sql);
    $stmt->execute();
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Ảnh</label>
                                    <input type="file" name="cate_img" class="form-control" style="width: 100%;"
                                        value="<?= $cate['cate_img'] ?>">
                                    <?php if (!empty($cate['cate_img'])) : ?>
                                    <img src="../upload/<?= $cate['cate_img'] ?>" alt="" width="130">
                                    <br>
                                    <?php endif; ?>
                                </div>
                                <!-- /.form-group -->
