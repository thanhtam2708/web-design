                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="addpro.php" class="btn btn-primary">Thêm sản phẩm</a>
                                </div>
                                <div class="card-body">
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?= $pro['pro_id'] ?></td>
                                                <td><?= $pro['pro_name'] ?></td>
                                                <td><img src="../upload/<?= $pro['pro_img'] ?>" alt="" width="150"></td>
                                                <td><?= $pro['price'] ?></td>
                                                <td><?= $pro['sale'] ?></td>
                                                <td><?= $pro['detail'] ?></td>
                                                <td><?= $pro['amount'] ?></td>
                                                <td><?= $pro['cate_name'] ?></td>
                                                <td> <a href="editPro.php?pro_id=<?= $pro['pro_id'] ?>" type="submit"
                                                        class="btn btn-primary" name="sua">Sửa</a>
                                                    <a href="deletePro.php?pro_id=<?= $pro['pro_id'] ?>"
