...
if (isset($_POST['btnThem'])) {
    ...
    $sql = "INSERT INTO info set address='$address', email='$email', phone='$phone', license='$license', logo='$logo'";
                    ...
                    <div class="mb-2 row">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Thêm Info</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                            ...
                            <div class="row">
                                <div class="col-sm-12" style="float: left;">
                                    <div class="col-sm-8" style="float: left;">
                                        <div class="form-group">
                                            <button type="submit" name="btnThem" id="" class="btn btn-primary" btn-lg
