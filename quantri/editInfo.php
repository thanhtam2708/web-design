...
if (isset($_GET['info_id'])) {
    ...
    $stmt->execute();
    $infomation = $stmt->fetchAll(PDO::FETCH_ASSOC);
    $info = $infomation[0];
}
//update
if (isset($_POST['btnSua'])) {
    ...
    $sql = "UPDATE info set address='$address', email='$email', phone='$phone', license='$license', logo='$logo' where info_id=$info_id";
    $stmt = $conn->prepare($sql);
    $stmt->execute();
                    ...
                    <div class="mb-2 row">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Sửa Info</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-6" style="float: left;">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="address" id=""
                                                aria-describedby="helpId" placeholder="địa chỉ" required
                                                value="<?= $info['address'] ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6" style="float: left;">
                            ...
                            <div class="row">
                                <div class="col-sm-12" style="float: left;">
                                    ...
                                    <div class="col-sm-6" style="float: left;">
                                        <div class="form-group">
                                            <label for="">Cấp phép</label>
                                            <input type="text" class="form-control" name="license" id=""
                                                aria-describedby="helpId" placeholder="cấp phép" required
                                                value="<?= $info['license'] ?>">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFile" name="logo"
                                                    required value="<?= $info['logo'] ?>">
                                                <label class="custom-file-label" for="customFile">Chọn File</label>
                                                <?php if (!empty($info['logo'])) : ?>
                                                <img src="../upload/<?= $info['logo'] ?>" alt="" width="130">
                                                <br>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12" style="float: left;">
                                    <div class="col-sm-8" style="float: left;">
                                        <div class="form-group">
                                            <button type="submit" name="btnSua" id="" class="btn btn-primary" btn-lg
                                                btn-block>Sửa</button>
                                            <a name="" id="" class="btn btn-danger" href="info.php" role="button">Quay
                                                Lại</a>
                                        </div>
                                    </div>
